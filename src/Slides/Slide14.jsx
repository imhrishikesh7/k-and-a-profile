...
const Slide13 = () => {
    ...
    return (
        ...
        >
            <div className="marginal !h-[85vh] w-[97%]  flex flex-wrap justify-center font-extended">
                {/* 65% Width Container */}
                <div className="flex p-4 h-full w-[65%] space-x-4">
                    ...
                    <h1 className="text-5xl bg-gradient-to-r w-fit bg-clip-text text-transparent from-[#000000] to-[#f6c419] font-exb mb-3">
                        ...
                        >
                            <h1 className="text-5xl bg-gradient-to-r w-fit bg-clip-text text-transparent from-[#000000] to-[#f6c419] font-exb mb-3">
                                Branding</h1>
                            <p className="text-2xl">_Coffee table book</p>
                            <p className="text-2xl">_Stationary</p>
                            <p className="text-2xl">_Newsletter</p>
                            <p className="text-2xl">_Corporate brochure</p>
                            <p className="text-2xl">_Events</p>
                ...
                <div className="flex flex-col h-full justify-end bg-[#f7f7f8] w-[35%] relative overflow-hidden">
                    <AnimatePresence>
                        <motion.img
                            key={currentImage} // Re-render image when it changes
                            src={images[currentImage]}
                            className="w-full mix-blend-multiply absolute object-cover"
            ...
            <Navigation theme="black" page="14" />
        </div>
    );
};
